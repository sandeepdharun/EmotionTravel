...
export const tamilNaduDestinations: Destination[] = [
  {
    ...
    touristPlaces: [
      {
        name: "Emerald Lake",
        description: "A quiet escape where emerald waters meet rolling tea gardens, perfect for finding stillness away from the crowds.",
        category: "nature",
        emotion: "Calm / Healing",
      },
      {
        name: "Avalanche Lake",
        description: "Experience true silence at this untouched alpine lake, where mist and forests create a cinematic, world-away feeling.",
        category: "nature",
        emotion: "Calm / Healing",
      },
      {
        name: "Upper Bhavani Reservoir",
        description: "Drive through rolling grasslands to find this hidden blue reservoir, offering solitude and raw natural beauty.",
        category: "nature",
        emotion: "Calm / Healing",
      },
      {
        name: "Cairn Hill Forest",
        description: "Walk under a canopy of ancient cypress trees in this shady trail, ideal for slow contemplation and quiet moments.",
        category: "nature",
        emotion: "Calm / Healing",
      },
      {
        name: "Sandynallah Reservoir (Kamaraj Sagar Dam)",
        description: "A favorite spot for photographers and peace-seekers, featuring still waters that perfectly mirror the surrounding hills.",
        category: "nature",
        emotion: "Calm / Healing",
      },
      {
        name: "Stone House",
        description: "Step back in time at Ooty’s first bungalow, a historic remnant of the British era surrounded by peaceful green lawns.",
        category: "historical",
        emotion: "Calm / Healing",
      },
      {
        name: "Pine Forest (Shooting Spot)",
        description: "Wander through towering pines where filtered sunlight creates a dreamy, film-like atmosphere for memorable walks.",
        category: "nature",
        emotion: "Mystery / Cinematic",
      },
      {
        name: "Parsons Valley",
        description: "Explore a protected, wilder side of Ooty with misty meadows and dense forests that feel untouched by time.",
        category: "nature",
        emotion: "Mystery / Cinematic",
      },
      {
        name: "Wenlock Downs (9th Mile)",
        description: "Stand on endless rolling green downs that touch the clouds, making you feel like you’re on a movie set.",
        category: "nature",
        emotion: "Mystery / Cinematic",
      },
      {
        name: "Needle Rock View Point",
        description: "A dramatic cliff-edge viewpoint offering 360-degree panoramas that reveal the sheer scale of the Nilgiris.",
        category: "nature",
        emotion: "Mystery / Cinematic",
      },
      {
        name: "Mukurthi National Park",
        description: "For the adventurous soul, this high-altitude park offers raw wilderness, shola forests, and a chance to spot rare wildlife.",
        category: "nature",
        emotion: "Mystery / Cinematic",
      },
      {
        name: "Doddabetta Peak",
        description: "The highest point in the Nilgiris guarantees a breathtaking view that puts the entire region into perspective.",
        category: "nature",
        emotion: "Awe / Wow",
      },
      {
        name: "Pykara Waterfalls",
        description: "Witness the power of nature as cascading waters flow through rocky beds and thick forests.",
        category: "nature",
        emotion: "Awe / Wow",
      },
      {
        name: "Glenmorgan Viewpoint",
        description: "Skip the crowds and head here for a stunning, deep-valley view that showcases the vastness of the tea estates.",
        category: "nature",
        emotion: "Awe / Wow",
      },
      {
        name: "Elk Hill Murugan Temple",
        description: "Marvel at the giant golden statue standing tall against the backdrop of the town and hills.",
        category: "temple",
        emotion: "Awe / Wow",
      },
      {
        name: "Rose Garden",
        description: "Lose yourself in India’s largest rose garden, a terraced paradise of colors and fragrances perfect for a leisurely stroll.",
        category: "nature",
        emotion: "Romantic / Social",
      },
      {
        name: "Ooty Botanical Garden",
        description: "A living library of rare trees and vibrant flowers, ideal for a relaxed afternoon picnic with family or friends.",
        category: "nature",
        emotion: "Romantic / Social",
      },
      {
