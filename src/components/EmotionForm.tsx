...
export const EmotionForm = () => {
  ...
  return (
    <section className="py-20 px-6">
      <div className={`mx-auto ${showRecommendations ? "max-w-7xl" : "max-w-4xl"}`}>
                    ...
                    {emotionOptions.map((emotion) => {
                      ...
                      return (
                        <Button
                          ...
                          className={`h-auto py-4 px-4 flex flex-col items-center gap-2 transition-all duration-300 ${isSelected
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {desiredChangeOptions.map((option) => (
                      <Button
                        ...
                        className={`h-auto p-6 flex flex-col items-start gap-2 text-left transition-all duration-300 ${desiredChange === option.id
                          ? 'border-primary bg-primary/10 shadow-soft'
                          : 'border-border hover:border-primary/50 hover:shadow-soft'
                          }`}
                      >
